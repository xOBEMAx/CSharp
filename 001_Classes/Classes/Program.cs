...
namespace Classes
{
    ...
    class Program
    {
        static void Main()
        {
            // 1. Создаем экземпляр класса MyClass с именем instance.
            // 2. Инстанцируем класс MyClass.
            // 3. Создаем переменную с именем instance, типа MyClass и присваиваем ей адрес экземпляра на куче. 
